...
<template>
  ...
  <div class="home-page home-page--dark-mode">
    ...
    <main>
      <aside class="boards-nav hide-for-mobile">
        <h2>ALL BOARD (3)</h2>
...
@include m.breakpoint-up(medium) {
  .home-page {
    ...
    flex-direction: column;
    header {
      height: f.toRem(81, 12);
      display: grid;
      align-items: unset;
      grid-template-columns:
        f.toRem(261, 12) minmax(f.toRem(159+107, 12), auto) f.toRem(164, 12)
        ...
        .sidebar-content {
          ...
          .cta {
            ...
            .hide-sidebar {
              ...
              padding: f.toRem(14, 12) f.toRem(94, 12) f.toRem(14, 12)
                f.toRem(24, 12);
              left: f.toRem(0, 12);
              cursor: pointer;
              display: flex;
...
@include m.breakpoint-up(large) {
  .home-page {
    header {
      display: grid;
      height: f.toRem(96, 12);
      grid-template-columns:
        f.toRem(301, 12) minmax(f.toRem(159+107, 12), auto) f.toRem(164, 12)
        f.toRem(5+24.38+24, 12);
      grid-template-rows: 1fr;
      grid-template-areas: "brand board-name new-task board-action";
